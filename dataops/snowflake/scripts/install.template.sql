...
CREATE OR REPLACE DATABASE {{ env.DATAOPS_PREFIX }}_DB;
CREATE SCHEMA IF NOT EXISTS {{ env.DATAOPS_PREFIX }}_DB.TEST;
CREATE or replace STAGE {{ env.DATAOPS_PREFIX }}_DB.TEST.QUICKSTART 
...
VALUES
('INSTALL_DB','{{ env.DATAOPS_PREFIX }}_DB'),
('ADMIN_SCHEMA','TEST'),
('OPS_SCHEMA','TEST'),
('RESULT_SCHEMA','TEST'),
